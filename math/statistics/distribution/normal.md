...
假设一个外科手术成功率为 85%，当医生对 10 位患者进行该手术，可以使用二项公式计算恰好两次手术成功的概率。如果医生对 150 名患者进行手术，少于 100 次成功的概率是多少？如果使用二项式公式，需要计算 100 次概率然后求和。这种方法不切实际，更好的办法是使用正态分布来近似二项分布。
...
<img src="images/2024-11-07-11-26-42.png" style="zoom: 50%;" />
